...
//***********************************************
void CCrc32Static::BufferCrc32(const LPVOID lpvBuf, DWORD dwCount, DWORD &dwCrc32)
{
	for (const BYTE *cptr = (const BYTE *)lpvBuf; cptr < (const BYTE *)lpvBuf + dwCount; ++cptr)
		CalcCrc32(*cptr, dwCrc32);
}