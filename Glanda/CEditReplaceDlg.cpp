...
void CEditReplaceDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT_FIND, m_sText);
...
BEGIN_MESSAGE_MAP(CEditReplaceDlg, CDialog)
	...
	ON_EN_CHANGE(IDC_EDIT_FIND, OnChangeEditText)
...
{
	CString text;
	GetDlgItem(IDC_EDIT_FIND)->GetWindowText(text);
...
void CEditReplaceDlg::OnEditReplaceAll() 
{
	...
	{
		CString str;
		str.Format(IDS_EDIT_REPLACED_COUNT, m_nReplaced);
